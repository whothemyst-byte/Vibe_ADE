# Graph Report - vibe-space  (2026-06-20)

## Corpus Check
- 214 files · ~181,498 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1547 nodes · 2498 edges · 122 communities (115 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74118dfa`
...
Cohesion: 0.11
Nodes (22): designPath(), ensureDesignFile(), formatReference(), resolveDesignPath(), mocked, DesignPage(), Initial, EchoGuard (+14 more)

### Community 1 - "Settings + App Shell"
Cohesion: 0.22
Nodes (11): DEFAULT_SETTINGS, isBackground(), isRecord(), mergeSettings(), num(), Settings, SettingsStore, loadSettings() (+3 more)
...
Cohesion: 0.12
Nodes (46): AppHandle, Option, PathBuf, Result, write_atomic(), writes_and_overwrites_atomically(), import_background(), base() (+38 more)
...
Cohesion: 0.05
Nodes (46): ClerkWindow, getClerkToken(), W, supabase, CompositeTypes, Constants, Database, DatabaseWithoutInternals (+38 more)
...
Cohesion: 0.16
Nodes (15): setBrowserSyncHandler(), syncBrowserRect(), useBrowserBlockers, BrowserWindow, BrowserWindowInner(), AppStateLike, excalidrawCamera(), excalidrawViewport() (+7 more)
...
Cohesion: 0.19
Nodes (17): accentForBackground(), applyAccent(), isThemeActive(), onAccentText(), Theme, THEMES, BROWSER_PANE, browserLayout() (+9 more)
...
Cohesion: 0.26
Nodes (8): relativeTime(), WallCard(), deleteWall(), isDir(), loadThumbnailUrl(), basename(), spaceFromFolder(), WallMeta
...
Cohesion: 0.11
Nodes (19): connectedProviders(), KNOWN, memberSince(), providerLabel(), AccountPane(), AgentsPane(), APP_SECTIONS, BackgroundPicker() (+11 more)
...
Cohesion: 0.17
Nodes (14): BrowserCard, Card, CardStore, FileCard, TerminalCard, terminalsOf(), useCardStore, closeFile() (+6 more)
...
Cohesion: 0.24
Nodes (13): loadPresets(), nearestSlotIndex(), DEFAULT_PRESETS, findPresetByPhrase(), Preset, resolvePreset(), PresetStore, usePresetStore (+5 more)
...
Cohesion: 0.07
Nodes (26): DirEntry, readDir(), useBlocksBrowser(), FileExplorer(), BackIcon(), ChevronDownIcon(), ChevronRightIcon(), ChevronUpIcon() (+18 more)
...
Cohesion: 0.27
Nodes (9): clerkAppearance, App(), View, openFolder(), pickFolder(), useVibeCommand(), useVibeContext(), VibeAgent() (+1 more)
...
## Knowledge Gaps
- **660 isolated node(s):** `View`, `DEFAULT_CAMERA`, `Initial`, `mocked`, `Session` (+655 more)
...
- **What connects `View`, `DEFAULT_CAMERA`, `Initial` to the rest of the system?**
