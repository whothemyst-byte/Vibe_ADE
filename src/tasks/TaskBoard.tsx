...
import { BackIcon, GridIcon, MoreIcon } from "../wall/icons";
            ...
            {menuOpen && (
              <>
                ...
                <div className="tb-menu" role="menu">
                  <button
                    className={`tb-menu-item${ent.canImportExternal ? "" : " tb-locked"}`}
                  ...
                  <button
                    className={`tb-menu-item${ent.canUseSavedViews ? "" : " tb-locked"}`}
