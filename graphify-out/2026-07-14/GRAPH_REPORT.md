...
## Corpus Check
- 266 files · ~239,569 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1896 nodes · 3096 edges · 146 communities (139 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `adc021c8`
...
Cohesion: 0.12
Nodes (22): designPath(), ensureDesignFile(), formatReference(), resolveDesignPath(), mocked, Initial, DesignShortcuts(), ROWS (+14 more)

### Community 1 - "Settings + App Shell"
Cohesion: 0.15
Nodes (17): DEFAULT_SETTINGS, isBackground(), isRecord(), mergeSettings(), num(), Settings, SettingsStore, loadPresets() (+9 more)

### Community 2 - "Vibe Agent Loop + Commands"
Cohesion: 0.06
Nodes (47): AgentOptions, AgentResult, ASK_USER, ChatFn, runAgent(), systemPrompt(), _clearRegistryForTests(), getToolDefs() (+39 more)
...
Cohesion: 0.14
Nodes (16): ClerkWindow, getClerkToken(), W, attachActivityListeners(), detachActivityListeners(), joinOrgPresence(), lastActivity, leavePresence() (+8 more)
...
Cohesion: 0.11
Nodes (21): accentForBackground(), APPEARANCE_THEMES, applyAccent(), applyChromeInk(), isThemeActive(), readableTextColor(), Theme, THEMES (+13 more)
...
Cohesion: 0.26
Nodes (11): MembersPane(), OrganizationPane(), ProjectsPane(), SettingsModal(), ClerkUser, ClerkWindow, currentProfile(), currentUserId() (+3 more)
...
Cohesion: 0.14
Nodes (18): readTextFile(), setBrowserSyncHandler(), syncBrowserRect(), useBrowserBlockers, BrowserWindow, BrowserWindowInner(), useCardStore, FileViewerWindow (+10 more)
...
Cohesion: 0.16
Nodes (18): applyExternalScene(), commitPatches(), selectOnly(), selectSmart(), setSelectedGroup(), applyPatches(), bumpElement(), El (+10 more)
...
Cohesion: 0.24
Nodes (8): OrbitPos, orbitPositions(), RING_CAPACITY, RING_FRACTION, Member, Org, usePresenceStore, SolarSystem()

### Community 119 - "Community 119"
Cohesion: 0.07
Nodes (28): DirEntry, readDir(), useBlocksBrowser(), FileExplorer(), ChevronDownIcon(), ChevronRightIcon(), ChevronUpIcon(), DesignIcon() (+20 more)
...
Cohesion: 0.22
Nodes (9): BrowserCard, Card, CardStore, FileCard, TerminalCard, closeFile(), fileCard(), openFile() (+1 more)
...
Cohesion: 0.25
Nodes (9): setViewport(), DesignZoomIsland(), fitAll(), fitSelection(), anchoredZoom(), clampZoom(), stepZoom(), view (+1 more)
...
Cohesion: 0.38
Nodes (5): DesignPage(), createDesignStore(), EchoGuard, hashText(), makeEchoGuard()
...
Cohesion: 0.22
Nodes (9): relativeTime(), WallCard(), deleteWall(), isDir(), loadThumbnailUrl(), basename(), spaceFromFolder(), WallMeta (+1 more)
...
Cohesion: 0.13
Nodes (10): commitReorder(), DesignSelectionActions(), ICONS, GroupEl, groupPatches(), sharedOuterGroup(), ungroupPatches(), reorderElements() (+2 more)

### Community 139 - "Community 139"
Cohesion: 0.11
Nodes (23): setSnapMode(), DesignLeftBar(), GROUPS, DesignSnapshot, DesignStore, EMPTY_SNAPSHOT, LayerRow, layersEqual() (+15 more)
...
Cohesion: 0.22
Nodes (12): clerkAppearance, AgentsPane(), App(), View, openFolder(), pickFolder(), TaskBoard(), useVibeCommand() (+4 more)
...
Cohesion: 0.19
Nodes (9): InvitesPane(), openableSpaceFor(), isValidEmail(), OrgLike, resolveCurrentOrg(), orgs, Invite, OrgStore (+1 more)
...
## Knowledge Gaps
- **806 isolated node(s):** `The competitor`, `Vibe Space's position`, `Roadmap structure`, `2. Package A — Voice → Agent Dictation (DONE — reference for style)`, `What CNVS does (observed in the demo)` (+801 more)
...
- **What connects `The competitor`, `Vibe Space's position`, `Roadmap structure` to the rest of the system?**
