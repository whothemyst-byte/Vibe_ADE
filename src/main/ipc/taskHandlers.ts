...
import type { PaneId, TaskItem, TaskPriority, TaskStatus, WorkspaceId, WorkspaceState } from '@shared/types';
import type { WorkspaceManager } from '@main/services/WorkspaceManager';
import { exportTasksToDirectory } from '@main/services/EnvironmentFileManager';
import { assertNonEmptyString, assertPaneId, assertRecord, assertWorkspaceId } from './shared/validators';
...
export function registerTaskHandlers({ workspaceManager }: Deps): void {
