# Graph Report - vibe-space  (2026-06-19)

## Corpus Check
- 197 files · ~165,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1450 nodes · 2322 edges · 125 communities (115 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4dadd4c2`
...
Cohesion: 0.16
Nodes (16): setBrowserSyncHandler(), syncBrowserRect(), useBrowserBlockers, BrowserWindow, BrowserWindowInner(), useCardStore, CloseIcon(), ReloadIcon() (+8 more)

### Community 1 - "Settings + App Shell"
Cohesion: 0.19
Nodes (13): DEFAULT_SETTINGS, isBackground(), isRecord(), mergeSettings(), num(), Settings, SettingsStore, deleteWall() (+5 more)

### Community 2 - "Vibe Agent Loop + Commands"
Cohesion: 0.08
Nodes (36): AgentOptions, AgentResult, ASK_USER, ChatFn, runAgent(), systemPrompt(), _clearRegistryForTests(), getToolDefs() (+28 more)

### Community 3 - "Rust Atomic Store"
Cohesion: 0.14
Nodes (40): AppHandle, Option, PathBuf, Result, String, Vec, write_atomic(), writes_and_overwrites_atomically() (+32 more)

### Community 4 - "PTY Client + Agent Status"
Cohesion: 0.14
Nodes (24): exitChannel(), killPty(), onPtyExit(), resizePty(), spawnPty(), toBytes(), writePty(), AgentsPane() (+16 more)
...
Cohesion: 0.11
Nodes (10): ChevronDownIcon(), ChevronUpIcon(), EllipseIcon(), GlobeIcon(), ImageIcon(), PaletteIcon(), PlusIcon(), RectangleIcon() (+2 more)
...
### Community 62 - "Invite Link Builder"
Cohesion: 0.27
...
Cohesion: 0.17
Nodes (16): View, relativeTime(), StartPage(), WallCard(), loadIndex(), loadThumbnailUrl(), openFolder(), pickFolder() (+8 more)
...
Cohesion: 0.14
Nodes (13): APP_SECTIONS, BackgroundPicker(), CanvasPane(), CARD_EMOJI, Section, SPACE_ONLY, TEAM_SECTIONS, TerminalPane() (+5 more)

### Community 107 - "Community 107"
Cohesion: 0.32
Nodes (11): BROWSER_PANE, browserLayout(), CELL, fitCamera(), gridBBox(), gridPositions(), gridShape(), nearestSlotIndex() (+3 more)
...
Cohesion: 0.29
Nodes (5): BrowserCard, Card, CardStore, TerminalCard, terminalsOf()
...
Cohesion: 0.20
Nodes (11): saveThumbnail(), AGENT_NAMES, pickAgentName(), useBlocksBrowser(), AppStateLike, excalidrawCamera(), excalidrawViewport(), appState (+3 more)
...
## Knowledge Gaps
- **622 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+617 more)
...
- **Should `Rust PTY Actor` be split into smaller, more focused modules?**
