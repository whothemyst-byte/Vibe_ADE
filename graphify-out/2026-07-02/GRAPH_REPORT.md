...
## Corpus Check
- 251 files · ~215,941 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1705 nodes · 2751 edges · 137 communities (130 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5ec05b0c`
...
Cohesion: 0.11
Nodes (25): designPath(), ensureDesignFile(), formatReference(), resolveDesignPath(), mocked, DesignPage(), Initial, DesignTopBar() (+17 more)

### Community 1 - "Settings + App Shell"
Cohesion: 0.15
Nodes (15): DEFAULT_SETTINGS, isBackground(), isRecord(), mergeSettings(), num(), Settings, SettingsStore, DirEntry (+7 more)
...
Cohesion: 0.09
Nodes (23): applyPatches(), bumpElement(), El, hidePatch(), isHidden(), Patch, unhidePatch(), DesignRightPanel() (+15 more)
...
Cohesion: 0.16
Nodes (13): loadTasks(), saveTasks(), COLUMNS, PRIORITIES, TaskCard, normalizeTasks(), Priority, Task (+5 more)
...
Cohesion: 0.20
Nodes (11): relativeTime(), WallCard(), deleteWall(), isDir(), loadThumbnailUrl(), openFolder(), basename(), spaceFromFolder() (+3 more)
...
Cohesion: 0.18
Nodes (17): useBlocksBrowser(), Card, terminalsOf(), BROWSER_PANE, browserLayout(), CELL, fitCamera(), gridBBox() (+9 more)
...
Cohesion: 0.29
Nodes (11): MembersPane(), MyCardPane(), OrganizationPane(), ProjectsPane(), SettingsModal(), currentUserId(), useOrgStore, SolarSystem() (+3 more)
...
Cohesion: 0.08
Nodes (21): DesignLeftBar(), GROUPS, ChevronDownIcon(), ChevronRightIcon(), ChevronUpIcon(), DesignIcon(), EllipseIcon(), FileIcon() (+13 more)
...
Cohesion: 0.27
Nodes (8): CardStore, FileCard, TerminalCard, useCardStore, closeFile(), fileCard(), openFile(), removeCardWithFade()
...
Cohesion: 0.30
Nodes (9): clerkAppearance, App(), View, pickFolder(), TaskBoard(), useVibeCommand(), useVibeContext(), VibeAgent() (+1 more)
...
Cohesion: 0.31
Nodes (7): setBrowserSyncHandler(), syncBrowserRect(), useBrowserBlockers, BrowserWindowInner(), BrowserCard, CloseIcon(), ReloadIcon()
...
## Knowledge Gaps
- **712 isolated node(s):** `els`, `ZOp`, `Task 1: `align.ts` — rotated bboxes, group units, align/distribute patches`, `Task 2: `groups.ts` — group/ungroup patches`, `Task 3: `zorder.ts` — z-order reordering` (+707 more)
...
- **Why does `useSettingsStore` connect `Community 102` to `Settings + App Shell`, `Vibe Agent Loop + Commands`, `Community 132`, `PTY Client + Agent Status`, `Community 112`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `els`, `ZOp`, `Task 1: `align.ts` — rotated bboxes, group units, align/distribute patches` to the rest of the system?**
