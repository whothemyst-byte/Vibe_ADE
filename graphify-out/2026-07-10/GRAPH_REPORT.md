# Graph Report - vibe-space  (2026-07-02)

## Corpus Check
- 251 files · ~216,582 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1712 nodes · 2766 edges · 141 communities (135 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a90da32`
...
Cohesion: 0.14
Nodes (20): designPath(), ensureDesignFile(), formatReference(), resolveDesignPath(), mocked, Initial, DesignTopBar(), emptySceneJson() (+12 more)

### Community 1 - "Settings + App Shell"
Cohesion: 0.16
Nodes (16): DEFAULT_SETTINGS, isBackground(), isRecord(), mergeSettings(), num(), Settings, SettingsStore, loadSettings() (+8 more)
...
Cohesion: 0.12
Nodes (18): createDesignStore(), DesignSnapshot, DesignStore, EMPTY_SNAPSHOT, inspectorEqual(), InspectorSel, LayerRow, layersEqual() (+10 more)
...
Cohesion: 0.09
Nodes (32): APP_SECTIONS, BackgroundPicker(), CARD_EMOJI, InvitesPane(), isLightColor(), MembersPane(), MyCardPane(), OrganizationPane() (+24 more)
...
Cohesion: 0.23
Nodes (10): setBrowserSyncHandler(), syncBrowserRect(), useBrowserBlockers, BrowserWindow, BrowserWindowInner(), Camera, Rect, ScreenRect (+2 more)
...
Cohesion: 0.33
Nodes (7): applyPatches(), bumpElement(), El, hidePatch(), isHidden(), Patch, unhidePatch()
...
Cohesion: 0.33
Nodes (6): DesignLeftBar(), GROUPS, TOOL_ICONS, ToolDef, TOOLS, ToolsIsland()

### Community 119 - "Community 119"
Cohesion: 0.09
Nodes (18): DirEntry, readDir(), FileExplorer(), BackIcon(), ChevronDownIcon(), ChevronRightIcon(), ChevronUpIcon(), DesignIcon() (+10 more)
...
Cohesion: 0.15
Nodes (16): BrowserCard, Card, CardStore, FileCard, TerminalCard, terminalsOf(), useCardStore, closeFile() (+8 more)

### Community 127 - "Community 127"
Cohesion: 0.39
Nodes (9): Activity, formatElapsed(), isWorking(), newActivity(), recordOutput(), settle(), statusLabel(), workedMs() (+1 more)
...
Cohesion: 0.20
Nodes (13): clerkAppearance, AgentsPane(), App(), View, StartPage(), openFolder(), pickFolder(), TaskBoard() (+5 more)
...
Cohesion: 0.36
Nodes (5): DesignRightPanel(), degToRad(), labelForElement(), radToDeg(), SelectIcon()

### Community 135 - "Community 135"
Cohesion: 0.33
Nodes (3): reorderElements(), els, ZOp

### Community 136 - "Community 136"
Cohesion: 0.13
Nodes (15): saveThumbnail(), AGENT_NAMES, pickAgentName(), useBlocksBrowser(), AppStateLike, excalidrawCamera(), excalidrawViewport(), appState (+7 more)
...
Cohesion: 0.47
Nodes (4): DesignPage(), EchoGuard, hashText(), makeEchoGuard()
...
## Knowledge Gaps
- **715 isolated node(s):** `Initial`, `LayerRow`, `InspectorSel`, `MultiValue`, `LINEAR_TYPES` (+710 more)
...
- **Why does `useOrgStore` connect `Community 102` to `Community 122`, `Community 136`, `Realtime Presence`, `Canvas Tool Icons`, `Browser OAuth Sign-In`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `Initial`, `LayerRow`, `InspectorSel` to the rest of the system?**
